...
// Returns a random mobile deal qualifier
func Mobile() string {
	return randomFrom(jsonData.Mobile)
}

// Returns a random deal temp
func Temp() string {
	return randomFrom(jsonData.Temp)
}

// Returns a random Engineer
func Engineer() string {
	return randomFrom(jsonData.Engineer)
}

// Returns a random vertical
func Vertical() string {
	return randomFrom(jsonData.Vertical)
}

// Returns a random deal logo qualifier
func Logo() string {
	return randomFrom(jsonData.Logo)
}

// Returns a random region
func Region() string {
	return randomFrom(jsonData.Region)
}
...
// Returns a random next step
func NextSteps() string {
	return randomFrom(jsonData.NextSteps)
}
